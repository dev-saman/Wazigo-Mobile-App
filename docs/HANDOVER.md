# Wazigo Mobile App — Handover (end of Stage 14)
...
| 15. Final commit + push, and the first device pass | **next** |
...
5. Stage 15 in the plan is the final commit and push - done with every stage so far.
