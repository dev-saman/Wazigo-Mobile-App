...
export const network = {
  ...
  /** `body` is for endpoints that name what to delete in the request body (DELETE /me/devices). */
  delete: <T, M = undefined>(url: string, { body, ...options }: RequestOptions & { body?: unknown } = {}) =>
    send<T, M>('delete', url, body, options),
